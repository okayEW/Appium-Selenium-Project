package data.appiumCapabilities;

public class AppiumCapabilities {

    public static final String APPIUM_NODE = "http://localhost:4723/wd/hub";
    ...
    public static final String CHROME_DRIVER = "src/main/resources/chromeDriver/chromedriver_105.exe";
}